...
Anyway, it is a moot point since both are fantastic languages capable of handling almost any statistical task. I may try and create some posts that compare Python and R and possibly offer some tutorials that are Python focused.
